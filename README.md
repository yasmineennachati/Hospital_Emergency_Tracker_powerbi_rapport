...
Ce projet présente un **dashboard interactif Power BI** pour analyser les **opérations et la performance des urgences (ER)**.
...
* 🗓️ Dimension table: Calendar (Date, Year, Month)
...
* 📊 Monthly trends (visits & waiting time)
* 🏥 Admission rate by department
* 🚀 KPI: % of patients seen within 30 minutes
* 👥 Gender distribution
